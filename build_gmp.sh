...
build_aarch64()
{
    ...
    ../configure --host $TARGET --prefix="$PACKAGE_DIR" --enable-static=yes --with-pic --disable-fft &&
    make -j${NPROC} &&
    make install
...
build_host()
{
    ...
    ../configure --prefix="$PACKAGE_DIR" --enable-static=yes --with-pic --disable-fft &&
    make -j${NPROC} &&
    make install
...
build_host_noasm()
{
    ...
    ../configure --prefix="$PACKAGE_DIR" --enable-static=yes --with-pic --disable-fft --disable-assembly &&
    make -j${NPROC} &&
    make install
...
build_ios()
{
    ...
    ../configure --host $TARGET --prefix="$PACKAGE_DIR" --enable-static=yes --with-pic --disable-fft --disable-assembly &&
    make -j${NPROC} &&
    make install
